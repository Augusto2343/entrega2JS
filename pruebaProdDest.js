const contenedorProdDest = document.querySelector(".productosDest");
//botones de filtrado
...
let prodMostr=[]
let prodSubir =[]
const rutaJsonProd = "Dest";
const rutaJsonCarrito = "Carr";
const nomCarr="Carrito";
const nomProd="Productos";
btnBuscar.onclick = (e) =>{
    e.preventDefault();
    console.log("holaa ");
    ...
    if(inputBusqueda.value !=""){
     console.log("holaa buscando");
       ...
       prodMostr=arrProductos.filter( (producto) =>  producto.nombre.toLowerCase().includes(inputBusqueda.value.toLowerCase()))
        return mostrar();
    }
}
